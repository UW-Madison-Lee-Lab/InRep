...
class GenBlock(nn.Module):
    def __init__(self, in_channels, out_channels, g_spectral_norm, activation_fn, z_dims_after_concat):
...
class Generator(nn.Module):
    """Generator."""
    def __init__(self, z_dim, img_size, g_conv_dim, g_spectral_norm, attention, attention_after_nth_gen_block, activation_fn, initialize, G_depth, mixed_precision):
        ...
        self.z_dims_after_concat = self.chunk_size
    ...
    def forward(self, z, evaluation=False):
...
class Discriminator(nn.Module):
    """Discriminator."""
    def __init__(self, img_size, d_conv_dim, d_spectral_norm, attention, attention_after_nth_dis_block, activation_fn, nonlinear_embed, normalize_embed, initialize, D_depth, mixed_precision):
